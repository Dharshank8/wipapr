...
//		}
	...
	public void insertProductUsingProcedure() {
		...
		String prName = sc.next();
		pr.setPname(prName);
		dao.insertProductUsingProcedure(pr, null, prName);
		System.out.println("Product Added Successfully via Produre!!!");
	}
	
	
	public void geyProductNameById() {
		System.out.println("Enter the Prod ID to search:");
		int prid = sc.nextInt();
		dao.getProductNameById(prid, null);
